...
RECOMMENDED_WORKFLOW_HELP = (
    ...
    "Advanced commands:\n"
    "  onepage, v2-plan, v2-render, v2-compile, v2-patch, v2-outline, v2-make, v2-review, v2-iterate, clarify, clarify-web, ai-check, visual-draft\n"
...
def build_main_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        metavar="command",
        default="make",
        help="Primary commands: make, review, iterate. Use onepage for a single SIE body slide.",
    )
